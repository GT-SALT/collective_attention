...
def processFacebookComment(comment, status_id, parent_id=''):
    ...
    # cleanup
    comment_message = SPACE_FIXER.sub(" ", comment_message)
...
def scrapeFacebookPageFeedComments(file_id, access_token, status_file_name=None, out_file_name=None):
  if(out_file_name is None):
    out_file_name = '{}_facebook_comments.csv'.format(file_id)
  if(status_file_name is None):
    status_file_name = '{}_facebook_statuses.csv'.format(file_id)
  with open(out_file_name, 'w') as file:
      ...
      delim = '\t'
      with open(status_file_name, 'r') as csvfile:
